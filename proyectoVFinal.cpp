...
void escape(int companeros,int dinero){
	bool error= false;
	char decision;
	do{
	...
	cout<<endl<<"Numero de companeros con vida: "<<companeros<<endl;
	cout<<"dinero: "<<dinero<<endl<<endl;
	cout<<"es hora de escapar de la policia, tienen muchas opciones elige que hacer"<<endl;
	
	cout<<"a)Disfrazarse de civiles"<<endl;
	cout<<"b)Pedir un taxi "<<endl;
	cout<<"c)Escapar por los tueneles de la ciudad  "<<endl;
	cout<<"d) Salir del juego"<<endl;
	cin>>decision; 
	...
	switch(decision){
		...
		case 'a':{
			...
			cout<<endl<<"Numero de companeros con vida: "<<companeros<<endl;
			cout<<"dinero: "<<dinero<<endl<<endl;
			cout<<"Bien, ahora escoge tu disfraz"<<endl;
			
			cout<<"a)Disfrazarse de senora mayor"<<endl;
			cout<<"b)Disfrazarse como un empresario "<<endl;
			cout<<"c)Disfrazarse de policia"<<endl;
			cout<<"d) Salir del juego"<<endl;
			cin>>decision; 
			...
			switch(decision){
				...
				case 'a':{
					cout<<"Te vestiste como una senora mayor, pero tu complexion fisica y tu estatura no parecian los de una senora manor, la policia te investiga y termina arrestandote"<<endl;
					cout<<"fin del juego mas suerte para la proxima";
					exit(0);
					break;
				}
				case 'b':{
					cout<<"final bueno"<<endl;
					cout<<"Te vestiste como un empresario, te preguntaron sobre la gran cantidad de dinero que llevabas y dijiste que lo acabaste de sacar del banco"<<endl;
					cout<<"Despues de eso te fuiste a tu casa y pudiste descansar, fin del juego";
					cout<<"dinero total :"<<dinero;
					cout<<"dinero para ti:"<< dinero/companeros;
					exit(0);
					break;
				}
				...
				case 'c':{
					cout<<"La policia reconocio que no eras parte de la policia y te arresto"<<endl;
		...
		case 'b':{
			cout<<"Pidieron un taxi, el taxista le parecio sospechosa la situacion y llamo a la policia"<<endl;
			cout<<"fin del juego, mas suerte para la proxima";
			exit(0);
			break;
		}
		case 'c':{
			...
			cout<<endl<<"Numero de companeros con vida: "<<companeros<<endl;
			cout<<"dinero: "<<dinero<<endl<<endl;
			cout<<"Se escaparon por las alcantarillas, estan muy sucias despues de caminar un rato ven 3 salidas cual tomas"<<endl;
			cout<<"a)Primer salida, arriba se ve un negocio de venta de tamales "<<endl;
			cout<<"b)Segunda salida, arriba se ve un terreno baldio "<<endl;
			cout<<"c)Tercer salida, arriba se ven perros corriendo   "<<endl;
			cout<<"d) Salir del juego"<<endl;
			cin>>decision; 
			...
			switch(decision){
				...
				case 'a':{
					cout<<"Saliste por la primer salida, era una salida hacia la ciudad principal, en ese punto ya habian muchos policias buscandolos y terminan capturandoilos"<<endl;
					cout<<"fin del juego mas suerte para la proxima";
					exit(0);
				}
				case 'b':{
					cout<<"final bueno"<<endl;
					cout<<"Salieron a un terreno baldio y solitariom seguro para escapar terminas de despedirte de tus companeros y te vas a tu casa<<endl";
					cout<<"dinero total :"<<dinero;
					cout<<"dinero para ti:"<< dinero/companeros;
					exit(0);
					break;
				...
				case 'c':{
					cout<<"Saliste a un centro policial, los perros estaban corriendo en su entrenamiento, terminan por morderte y los policias te capturan<<endl";
					cout<<"fin del juego mas suerte para la proxima";
					exit(0);
					break;
				}
...
void escapeh(int companeros, int dinero){
char decision;
bool error= false;
do{
	...
	cout<<endl<<"Numero de companeros con vida: "<<companeros<<endl;
	cout<<"dinero: "<<dinero<<endl<<endl;
	cout<<"has decidido escapar en el helicoptero con el que entraste, subes a la azotea"<<endl;
	cout<<"logran distanciarse elige donde estacionar el helicoptero"<<endl; 
	cout<<"a)Estacionarse cerca de la costa"<<endl;
	cout<<"b)Estacionarse arriba de un edificio "<<endl;
	cout<<"c)Estacionarse en una isla lejana "<<endl;
	cout<<"d) Salir del juego"<<endl;
	cin>>decision; 
	...
	switch(decision){
		...
		case 'a':{
			...
			cout<<endl<<"Se estacionaron cerca de la costa, se empiezan a despedir pero alguien tiene que decidir que hacer con el helicoptero"<<companeros<<endl;
			cout<<"dinero: "<<dinero<<endl<<endl;
			
			cout<<"a)Quemarlo"<<endl;
			cout<<"b)Tirarlo al mar "<<endl;
			cout<<"c)Dejarlo ahi  "<<endl;
			cout<<"d) Salir del juego"<<endl;
			cin>>decision; 
			...
			switch(decision){
				...
				case 'a':{
					cout<<"Las llamas hicieron que la policia fuera a investigar, los metieron presos";
					cout<<"fin del juego mas suerte para la proxima";
					exit(0);
				}
				case 'b':{
					cout<<"la mejor decision fue tirarlo al mar, se deshicieron de la unica prueba del delito, y ahora puedes vivir una vida feliz"<<endl;
					cout<<"Fin del juego "<<endl;
					cout<<"dinero total: "<<dinero;
					cout<<"dinero para ti: "<< dinero/companeros;
					exit(0);
				...
				case 'c':{
					cout<<"Lo dejaron ahi, tiempo despues la policia lo encuentra y reastrea sus pasos, terminas preso"<<endl;
					cout<<"fin del juego mas suerte para la proxima";
					exit(0);
					break;
				}
		...
		case 'b':{
			cout<<"Un helicoptero arriba de un edificio es muy llamativo, los policias te encontraron"<<endl;
			cout<<"fin del juego, mas suerte para la proxima";
			exit(0);
			break;
		}
		case 'c':{
			...
			cout<<endl<<"Numero de companeros con vida: "<<companeros<<endl;
			cout<<"dinero: "<<dinero<<endl<<endl;
			cout<<"Intentaron  llegar hasta una isla lejana, las turbulencias son muy fuertes y el helicopterio se cae, quedan  a la deriva por varias semanas, tienen que decidir si pedir ayuda, lo que implica que probablemente los capturen"<<endl;
			
			cout<<"a)Pedir la ambulancia"<<endl;
			cout<<"b)Esperar mas tiempo "<<endl;
			cout<<"c)Animarlos a nadar hasta la costa "<<endl;
			cout<<"d) Salir del juego"<<endl;
			cin>>decision; 
			...
			switch(decision){
				...
				case 'a':{
					cout<<"Gracias a la desesperacion terminaron por pedir una ambulancia, lamentablemente los reconocieron y terminaste preso"<<endl;
					cout<<"fin del juego mas suerte para la proxima";
					exit(0);
				}
				case 'b':{
					cout<<"Esperas una semana, hasta que tu familia va a buscarte en tu yate privado, ahora puedes vivir feliz en la playa<<endl";
				...
				case 'c':{
					cout<<"final secreto"<<endl;
					cout<<"Animas a tus companeros a nadar hasta la costa, solo tu sobrevives por lo que te puedes quedar con todo lo que robaron";
					cout<<"Todo el dinero es tuyo: "<<dinero;
					exit(0);
					break;
				}
				case 'd':{
		...
		default: {
			cout<<"caracter no valido, por favor intentelo de nuevo";
			error=true;
		}
